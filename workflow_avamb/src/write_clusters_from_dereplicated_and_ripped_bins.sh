...
drep_dir="/nfsd/bcb/bcbg/spina/xamb_checkm_results/urog/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/xamb_checkm_results/urog/xavamb_manual_drep_disjoint_clusters.tsv"
