...
drep_dir="/nfsd/bcb/bcbg/spina/avamb_checkm_results/urog/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/avamb_checkm_results/urog/avamb_manual_drep_disjoint_clusters.tsv"
