...
drep_dir="/nfsd/bcb/bcbg/spina/pavamb_checkm_results/urog/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/pavamb_checkm_results/urog/pavamb_manual_drep_disjoint_clusters.tsv"
