...
drep_dir="/nfsd/bcb/bcbg/spina/xavamb_checkm_results/metahit/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/xavamb_checkm_results/metahit/xavamb_manual_drep_disjoint_clusters.tsv"
