...
drep_dir="/nfsd/bcb/bcbg/spina/avamb_checkm_results/metahit/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/avamb_checkm_results/metahit/avamb_manual_drep_disjoint_clusters.tsv"
