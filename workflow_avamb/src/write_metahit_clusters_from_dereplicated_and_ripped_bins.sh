...
drep_dir="/nfsd/bcb/bcbg/spina/pavamb_checkm_results/metahit/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/pavamb_checkm_results/metahit/pavamb_manual_drep_disjoint_clusters.tsv"
