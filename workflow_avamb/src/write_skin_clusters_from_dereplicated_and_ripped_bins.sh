...
drep_dir="/nfsd/bcb/bcbg/spina/xavamb_checkm_results/skin/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/xavamb_checkm_results/skin/xavamb_manual_drep_disjoint_clusters.tsv"
