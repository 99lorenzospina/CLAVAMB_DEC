...
drep_dir="/nfsd/bcb/bcbg/spina/avamb_checkm_results/skin/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/avamb_checkm_results/skin/avamb_manual_drep_disjoint_clusters.tsv"
