...
drep_dir="/nfsd/bcb/bcbg/spina/avamb_checkm_results/airways/Final_bins/"

output_file="/nfsd/bcb/bcbg/spina/avamb_checkm_results/airways/avamb_manual_drep_disjoint_clusters.tsv"
